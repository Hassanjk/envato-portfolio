  ...
  return (
    ...
    >
      ...
      <main className="lg:max-h-[1000px] hidden supports-sda:flex flex-1 py-14 lg:pb-9 relative flex-col text-gray-200">
        ...
        {/* Indicator */}
        <span className="flex font-semibold absolute top-14 right-7 text-[#FF0099]">
        ...
        <div className="px-7 max-lg:mt-10 flex flex-col items-center lg:items-start flex-1 max-lg:text-center lg:w-[29rem]">
          ...
          <div className="overlap flex-1 max-lg:items-start max-lg:justify-center max-lg:max-w-[36rem] lg:max-xl:max-w-[25cqw]">
            <div className="flex flex-col items-center lg:items-start">
              <h3 className="animate-text font-serif text-7xl lg:text-9xl w-fit text-white" style={{ ['animationTimeline' as string]: '--slide-1' }}>Abyss</h3>
              <p className="animate-text font-serif text-4xl lg:text-5xl mt-2 mb-auto w-3/4 text-[#FF0099]" style={{ ['animationTimeline' as string]: '--slide-1' }}>$39.90</p>
              <p className="max-lg:hidden font-serif text-3xl italic animate-text my-4 text-gray-300" style={{ ['animationTimeline' as string]: '--slide-1' }}>By 2050, there could be more plastic in our oceans than fish.</p>
              <p className="max-lg:hidden animate-text text-pr text-gray-400" style={{ ['animationTimeline' as string]: '--slide-1' }}>Plastic pollution injures more than 100,000 marine animals every year. It takes around 450 years for one plastic bottle to decompose.</p>
              <a href="https://closca.com" className="animate-text group pointer-events-auto inline-flex gap-4 items-center text-[#9B30FF] mt-6" style={{ ['animationTimeline' as string]: '--slide-1' }}>
            ...
            <div className="flex flex-col items-center lg:items-start">
              <h3 className="animate-text font-serif text-7xl lg:text-9xl w-fit text-white" style={{ ['animationTimeline' as string]: '--slide-2' }}>Black</h3>
              <p className="animate-text font-serif text-4xl lg:text-5xl mt-2 mb-auto w-3/4 text-[#FF0099]" style={{ ['animationTimeline' as string]: '--slide-2' }}>$39.90</p>
              <p className="max-lg:hidden font-serif text-3xl italic animate-text my-4 text-gray-300" style={{ ['animationTimeline' as string]: '--slide-2' }}>The area affected by desertification is approx 11x India's size.</p>
              <p className="max-lg:hidden animate-text text-pretty text-gray-400" style={{ ['animationTimeline' as string]: '--slide-2' }}>Every minute, over a million plastic bottles are manufactured, and only 9% of them will have a second life.</p>
              <a href="https://closca.com" className="animate-text group pointer-events-auto inline-flex gap-4 items-center text-[#9B30FF] mt-6" style={{ ['animationTimeline' as string]: '--slide-2' }}>
                <span className="font-semibold">Shop Now</span>
                <svg className="w-6 group-hover:translate-x-1 transition-transform" viewBox="0 0 24 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" clipRule="evenodd" d="M18.5303 0.469727L23.5607 5.50006L18.5303 10.5304L17.4697 9.46973L20.6893 6.25006H0.5V4.75006H20.6893L17.4697 1.53039L18.5303 0.469727Z" fill="currentColor"/>
                </svg>
            ...
            <div className="flex flex-col items-center lg:items-start">
              <h3 className="animate-text font-serif text-7xl lg:text-9xl w-fit text-white" style={{ ['animationTimeline' as string]: '--slide-3' }}>White</h3>
              <p className="animate-text font-serif text-4xl lg:text-5xl mt-2 mb-auto w-3/4 text-[#FF0099]" style={{ ['animationTimeline' as string]: '--slide-3' }}>$39.90</p>
              <p className="max-lg:hidden font-serif text-3xl italic animate-text my-4 text-gray-300" style={{ ['animationTimeline' as string]: '--slide-3' }}>By 2050, there could be more plastic in our oceans than fish.</p>
              <p className="max-lg:hidden animate-text text-pretty text-gray-400" style={{ ['animationTimeline' as string]: '--slide-3' }}>Every time you fill your bottle, you save 82.8 grams of CO2 and 12 grams of plastic.</p>
              <a href="https://closca.com" className="animate-text group pointer-events-auto inline-flex gap-4 items-center text-[#9B30FF] mt-6" style={{ ['animationTimeline' as string]: '--slide-3' }}>
                <span className="font-semibold">Shop Now</span>
                <svg className="w-6 group-hover:translate-x-1 transition-transform" viewBox="0 0 24 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" clipRule="evenodd" d="M18.5303 0.469727L23.5607 5.50006L18.5303 10.5304L17.4697 9.46973L20.6893 6.25006H0.5V4.75006H20.6893L17.4697 1.53039L18.5303 0.469727Z" fill="currentColor"/>
                </svg>
